...
export interface ApiLiturgicalCalendarLiturgicalCalendar
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::liturgical-calendar.liturgical-calendar'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Schedude: Schema.Attribute.Component<'text.text', true>;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::post.post'> &
      Schema.Attribute.Private;
    menu_item: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    postingDate: Schema.Attribute.Date;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::liturgical-calendar.liturgical-calendar': ApiLiturgicalCalendarLiturgicalCalendar;
