...
const items = [
    {
        ...
        title: "Các Giáo Họ",
        date: "15/10/2024",
        excerpt: "Thông tin về Các Giáo Họ tại Giáo xứ Ngọc Mạch...",
            ...
            <div className="container mx-auto px-4">
                <Breadcrumb className="mb-8">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/gioi-thieu" className="hover:text-primary transition-colors">Giới Thiệu</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Các Giáo Họ</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
