...
const items = [
    {
        ...
        title: "Chuyên mục",
        date: "15/10/2024",
        excerpt: "Thông tin về Chuyên mục tại Giáo xứ Ngọc Mạch...",
            ...
            <div className="container mx-auto px-4">
                <Breadcrumb className="mb-8">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/bai-viet" className="hover:text-primary transition-colors">Bài viết/Suy niệm</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Chuyên mục</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
