...
const trainingItems = [
    {
        ...
        date: "13/02/2025",
        excerpt: "Giáo xứ Ngọc Mạch xin thông báo về việc mở lớp giáo lý Hôn nhân – Dự tòng khóa 1 năm 2025 như sau: Thời gian Khai giảng vào ngày 20/02/2025 và học liên tục trong vòng 4,5 tháng...",
        image: "/images/news-1.jpg",
        category: "Giáo lý Hôn Nhân & Dự tòng",
    },
    {
        id: 2,
        title: "Lớp Giáo lý Thiếu Nhi Giáo xứ Ngọc Mạch",
        date: "10/02/2025",
        excerpt: "Lớp Giáo lý Thiếu Nhi được tổ chức hàng tuần để giúp các em thiếu nhi học hỏi về đức tin, giáo lý và sống đạo một cách tích cực...",
        image: "/images/news-2.jpg",
        category: "Giáo lý Thiếu Nhi",
    },
    {
        id: 3,
        title: "Lớp Tiếng Anh Giáo xứ Ngọc Mạch",
        date: "05/02/2025",
        excerpt: "Lớp Tiếng Anh được mở ra nhằm giúp các giáo dân, đặc biệt là giới trẻ, có cơ hội học hỏi và nâng cao trình độ tiếng Anh...",
        image: "/images/news-3.jpg",
        category: "Lớp Tiếng Anh",
    },
    {
        id: 4,
        title: "Cầu nguyện với Lời Chúa",
        date: "01/02/2025",
        excerpt: "Các buổi cầu nguyện với Lời Chúa được tổ chức thường xuyên để giúp mọi người suy niệm và sống Lời Chúa trong cuộc sống hàng ngày...",
        image: "/images/news-4.jpg",
        category: "Cầu nguyện với Lời Chúa",
    },
]
            ...
            <div className="container mx-auto px-4">
                ...
                <Breadcrumb className="mb-8">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Đào tạo</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                ...
                <div className="grid lg:grid-cols-4 gap-8 lg:gap-10">
                    ...
                    <aside className="lg:col-span-1 space-y-6 lg:sticky lg:top-6 lg:self-start">
                        ...
                        {/* Bài viết mới */}
                        <RecentPostsSidebar posts={trainingItems.slice(0, 4).map(item => ({
                            id: item.id,
                            title: item.title,
                            image: item.image
                        }))} />
