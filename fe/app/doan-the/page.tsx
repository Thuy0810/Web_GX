...
const organizationItems = [
    {
        id: 1,
        title: "Ca Đoàn Magis Giáo xứ Ngọc Mạch",
        date: "15/10/2024",
        excerpt: "Ca Đoàn Magis là một trong những ca đoàn chính của Giáo xứ Ngọc Mạch, được thành lập với mục đích phục vụ trong các Thánh lễ và các hoạt động phụng vụ của giáo xứ...",
    ...
    {
        id: 3,
        title: "Hội Hiền Mẫu Giáo xứ Ngọc Mạch",
        date: "10/10/2024",
        excerpt: "Hội Hiền Mẫu là một tổ chức quan trọng trong giáo xứ, tập hợp các bà mẹ cùng nhau cầu nguyện, học hỏi và phục vụ cộng đoàn...",
        image: "/images/news-3.jpg",
        category: "Hội",
    },
    {
        id: 4,
        title: "Hội Caritas Giáo xứ Ngọc Mạch",
        date: "05/10/2024",
        excerpt: "Hội Caritas hoạt động với mục đích thực hiện các công việc bác ái, giúp đỡ những người nghèo khó và những hoàn cảnh khó khăn trong cộng đoàn...",
            ...
            <div className="container mx-auto px-4">
                ...
                <Breadcrumb className="mb-8">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Đoàn thể</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                ...
                <div className="grid lg:grid-cols-4 gap-8 lg:gap-10">
                    ...
                    <aside className="lg:col-span-1 space-y-6 lg:sticky lg:top-6 lg:self-start">
                        ...
                        {/* Bài viết mới */}
                        <RecentPostsSidebar posts={organizationItems.slice(0, 4).map(item => ({
                            id: item.id,
                            title: item.title,
                            image: item.image
                        }))} />
