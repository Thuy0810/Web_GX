...
const items = [
    {
        id: 1,
        title: "Các biểu mẫu hành chính",
        date: "15/10/2024",
        excerpt: "Thông tin về Các biểu mẫu hành chính tại Giáo xứ Ngọc Mạch...",
            ...
            <div className="container mx-auto px-4">
                <Breadcrumb className="mb-8">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/tu-lieu" className="hover:text-primary transition-colors">Tư liệu</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Các biểu mẫu hành chính</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
