...
// Lọc chỉ lấy tin tức có category "Sinh hoạt/ Hoạt động"
const newsItems = allNewsItems.filter(item => item.category === "Sinh hoạt/ Hoạt động")

export default function SinhHoatPage() {
    return (
            ...
            <div className="container mx-auto px-4">
                ...
                <Breadcrumb className="mb-8">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Sinh hoạt/ Hoạt động</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
