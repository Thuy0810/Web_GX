...
const items = [
    {
        id: 1,
        title: "Giáo lý Hôn Nhân & Dự tòng",
        date: "15/10/2024",
        excerpt: "Thông tin về Giáo lý Hôn Nhân & Dự tòng tại Giáo xứ Ngọc Mạch...",
            ...
            <div className="container mx-auto px-4">
                <Breadcrumb className="mb-8">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/dao-tao" className="hover:text-primary transition-colors">Đào tạo</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Giáo lý Hôn Nhân & Dự tòng</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
